...
import { FetchFocusTaskUseCase } from './FetchFocusTasksUseCase';

describe('FetchFocusTaskUseCase', () => {
  let sut: FetchFocusTaskUseCase;
  ...
  beforeEach(() => {
    ...
    sut = new FetchFocusTaskUseCase(taskRepository, sessionRepository);
  });
