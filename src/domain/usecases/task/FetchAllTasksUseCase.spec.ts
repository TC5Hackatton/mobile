...
describe('FetchAllTasksUseCase', () => {
  ...
  it('should return all tasks from repository', async () => {
    const mockTasks = [
      Task.create('Task 1', 'Description 1', TimeType.CRONOMETRO, 60, 30, TaskStatus.DOING, 'task-1', 'user-1'),
      Task.create('Task 2', 'Description 2', TimeType.TEMPO_FIXO, 120, 120, TaskStatus.DONE, 'task-2', 'user-1'),
      Task.create('Task 3', 'Description 3', TimeType.CRONOMETRO, 90, 0, TaskStatus.TODO, 'task-3', 'user-1'),
    ];
  ...
  it('should propagate errors from repository', async () => {
    ...
    mockTaskRepository.getAll.mockRejectedValue(repositoryError);
