...
export function AppHeader({ onExpandPress, onThemeTogglePress }: AppHeaderProps) {
  ...
  return (
    <>
      ...
      <View style={styles.container} accessibilityLabel="Cabeçalho da aplicação">
        <Text style={styles.appName} accessibilityRole="header">MindEase</Text>
